...
public class Project {
	...
	public Project(int pjId, String pTitle,  String pSummary, String pDetailesDocLink, String type,
			int pAdmin) {
		super();
		this.pjId = pjId;
		this.pTitle = pTitle;
	...
	public String toString() {
		return "Project [pjId=" + pjId + ", pTitle=" + pTitle + ",  pSummary=" + pSummary
				+ ", pDetailesDocLink=" + pDetailesDocLink + ", type=" + type + ", pAdmin=" + pAdmin + "]";
	}
